...
$config['database']['type'] = __MYBB__DATABASE_TYPE__;
$config['database']['database'] = __MYBB__DATABASE_DATABASE__;
$config['database']['table_prefix'] = __MYBB__DATABASE_TABLE_PREFIX__;

$config['database']['hostname'] = __MYBB_DATABASE_HOST__;
$config['database']['username'] = __MYBB_DATABASE_USER__;
$config['database']['password'] = __MYBB_DATABASE_PASSWORD__; 
